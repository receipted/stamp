...
from src.surface.stamp import stamp, verify_stamp, verify_stamp_chain, stamp_chain_anchor, h, GENESIS, _canonical_json
# receipted pipeline available in full substrate (private)
...
def cmd_analyze(path: str, output_json: bool = False):
    ...
    # Output hash: hash of the analysis result
...
def cmd_verify(receipt_path: str):
    ...
    if verify_stamp(stmp):
        ...
        print(f"FAIL: receipt stamp invalid")
        sys.exit(1)
